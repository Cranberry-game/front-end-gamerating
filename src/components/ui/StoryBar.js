...
const StoryBar = ({imgSource="http://img.sc115.com/uploads1/sc/jpgs/1509/apic14886_sc115.com.jpg", imgDescription="lalala", title="title", description="description", time="2017-3-24"}) => {
